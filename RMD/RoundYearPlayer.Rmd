...
# Instructions:
- Sum the data by round and year.  18 hole scores for each roun that each player has played.  So I think the total number of rows would be divided by 4 (or some weighted avg. of 2 and 4)?
